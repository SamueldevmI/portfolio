...
const VERSAO = 'eldev-music-v1';
const CACHE_APP = `${VERSAO}-app`;
const CACHE_API = `${VERSAO}-api`;

const ARQUIVOS = [
  './', 'index.html', 'style.css', 'manifest.webmanifest',
  'js/app.js', 'js/audius.js', 'js/db.js', 'js/id3.js', 'js/importar.js', 'js/menus.js', 'js/nav.js',
  'js/player-ui.js', 'js/player.js', 'js/store.js', 'js/telas.js', 'js/ui.js', 'js/util.js',
